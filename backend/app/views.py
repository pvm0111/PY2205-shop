...
## GET USER PROFILE(DETAILS) CHO NGUOI DUNG THUONG
@api_view(['GET'])
...
def updateUserProfile(request):
    ...
    if data['password'] != '':
        user.password = make_password(data['password'])  ##ma hoa password
    user.save() 
...
## GET USER PROFILE(DETAILS) CHO NGUOI DUNG ADMIN
@api_view(['GET'])
...
'''
    -----------CHUA LAM PHAN TRANG CHO SAN PHAM-------------
